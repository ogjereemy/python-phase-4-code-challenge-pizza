...
#     # add relationship
#     restaurant_pizzas = relationship('RestaurantPizza', back_populates='restuarant', cascade='all, delete-orphan' )
#     restaurant = association_proxy('restaurant_pizzas', 'pizza')
